...
const { livescore } = require('../processor');
...
async function start(workerId) {
    ...
    // Livescore queue handler, Will process livescore
    workQueue.process(maxJobsPerWorker, livescore);
}
